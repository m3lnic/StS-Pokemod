...
import pokemodCore.cards.move.TailWhip;
import pokemodCore.patches.AbstractCardEnum;

public class TailWhipTM extends PokeTM {
    public static final String ID = "pokemod:tail_whip:tm";
    ...
    private static final PokeMove MOVE = new TailWhip();
