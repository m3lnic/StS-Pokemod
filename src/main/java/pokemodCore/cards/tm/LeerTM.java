...
import pokemodCore.cards.move.Leer;
import pokemodCore.cards.move.PokeMove;
import pokemodCore.patches.AbstractCardEnum;

public class LeerTM extends PokeTM {
    public static final String ID = "pokemod:leer:tm";
    ...
    private static final PokeMove MOVE = new Leer();
