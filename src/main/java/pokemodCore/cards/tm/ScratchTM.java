...
import pokemodCore.cards.move.Scratch;
import pokemodCore.cards.move.Tackle;
import pokemodCore.patches.AbstractCardEnum;

public class ScratchTM extends PokeTM {
    public static final String ID = "pokemod:scratch:tm";
    ...
    private static final PokeMove MOVE = new Scratch();
