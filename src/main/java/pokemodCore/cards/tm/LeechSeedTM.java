...
import pokemodCore.cards.move.LeechSeed;
import pokemodCore.cards.move.PokeMove;
import pokemodCore.patches.AbstractCardEnum;

public class LeechSeedTM extends PokeTM {
    public static final String ID = "pokemod:leech_seed:tm";
    ...
    private static final PokeMove MOVE = new LeechSeed();
