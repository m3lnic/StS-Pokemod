...
import pokemodCore.cards.move.Tackle;
import pokemodCore.patches.AbstractCardEnum;

public class TackleTM extends PokeTM {
    public static final String ID = "pokemod:tackle:tm";
    private static CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    public static final String IMG_PATH = "image/cards/tackle/tackle.png";
    public static final CardRarity CARD_RARITY = CardRarity.COMMON;
    public static final CardType CARD_TYPE = CardType.SKILL;
    public static final CardTarget CARD_TARGET = CardTarget.NONE;
    private static final int COST = 0;
    private static final PokeMove MOVE = new Tackle();
