...
public class DarkEnergy extends EnergyBase {
    public static final String ID = "pokemod:dark_energy";
    private static CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    public static final String IMG_PATH = "image/cards/dark_energy/dark_energy.png";
    private static final int COST = 1;
    private static final ENERGY_TYPE_ENUM ENERGY_TYPE = ENERGY_TYPE_ENUM.DARK;
    ...
    public DarkEnergy() {
        ...
        this.tags.add(PokemodCardTags.TYPE_DARK);
    }
