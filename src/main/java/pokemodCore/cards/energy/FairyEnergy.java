...
public class FairyEnergy extends EnergyBase {
    public static final String ID = "pokemod:fairy_energy";
    private static CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    public static final String IMG_PATH = "image/cards/fairy_energy/fairy_energy.png";
    private static final int COST = 1;
    private static final ENERGY_TYPE_ENUM ENERGY_TYPE = ENERGY_TYPE_ENUM.FAIRY;
    ...
    public FairyEnergy() {
        ...
        this.tags.add(PokemodCardTags.TYPE_FAIRY);
    }
